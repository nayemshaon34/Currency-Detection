...
public abstract class CameraActivity extends AppCompatActivity
  ...
  public synchronized void onResume() {
    ...
    mp1 = MediaPlayer.create(this, R.raw.five);
    mp2 = MediaPlayer.create(this, R.raw.one);
  ...
  protected void showResultsInBottomSheet(List<Classifier.Recognition> results) {
    ...
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
        ...
        try {
          if (!fivehundred && recognitionTextView.getText().toString().equalsIgnoreCase("500") && confi>99 ) {
            mp1.start();
            fivehundred =true;
            thousand = false;
            hundred = false;
            ...
            fivehundred =false;
            thousand = false;
          } else if (!thousand&&recognitionTextView.getText().toString().equalsIgnoreCase("1000")&& confi>99 ) {
            mp2.start();
            thousand  =true;
            fivehundred =false;
            hundred = false;
